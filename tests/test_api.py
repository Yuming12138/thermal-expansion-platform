...
class ApiTests(unittest.TestCase):
    ...
    def test_health_and_dataset_summary(self) -> None:
        ...
        self.assertIn("/static/app.js?v=0.10.0-42", home.text)
        self.assertIn("/static/styles.css?v=0.10.0-28", home.text)
    ...
    def test_scientific_calculation_endpoints(self) -> None:
        ...
        self.assertEqual(kerner_curve.status_code, 200)
        self.assertEqual(kerner_curve.json()["matrix_phase"], "pte")
        self.assertAlmostEqual(kerner_curve.json()["rms_error_ppm_per_k"], 0.0, places=8)
